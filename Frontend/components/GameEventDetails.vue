<template>
  <div class="min-h-screen bg-gray-100 flex justify-center items-start py-10 dark:bg-black">
    <div class="bg-white rounded-xl shadow-lg max-w-4xl w-full p-6 dark:bg-gray-900">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="border border-gray-200 rounded-lg p-4 bg-gray-50 shadow-sm col-span-1 md:col-span-2 dark:bg-gray-800 dark:border-gray-500">
